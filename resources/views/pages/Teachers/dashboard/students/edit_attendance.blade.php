<!-- Informations supprimées sur l'étudiant -->
<div class="modal fade" id="edit_attendance{{$student->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
   <div class="modal-dialog">
       <div class="modal-content">
           <div class="modal-header">
               <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">Modifier la présence
                   et l'absence de l'étudiant : {{$student->name}}</h5>
               ...
               <form action="{{route('attendance.edit','test')}}" method="post">
                   ...
                   <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                       <input name="attendences"
                              ...
                              class="leading-tight" type="radio" value="présence">
