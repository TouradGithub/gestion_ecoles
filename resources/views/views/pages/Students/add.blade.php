            ...
            <div class="card-body">
                ...
                <form method="post"  action="{{ route('Students.store') }}" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="academic_year">Image logo : <span class="text-danger">*</span></label>
                                <input type="file" accept="image/*" name="" multiple>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="academic_year">Image website : <span class="text-danger">*</span></label>
