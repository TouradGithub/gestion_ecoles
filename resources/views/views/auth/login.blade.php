            ...
            <div class="row justify-content-center no-gutters vertical-align">
                <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                    ...
                    <div class="login-fancy">
                        <h2 class="text-white mb-20">مرحبا بكم</h2>
                        <p class="mb-20 text-white">أهلا بكم في منصتكم التعليميه
                            تم انشاء هذه المنصة من قبل الطالب الجامعي التراد ولد محمد الامين
                        </p>
                        <ul class="list-unstyled  pos-bot pb-30">
                            <li class="list-inline-item"><a class="text-white" href="#">   Use</a> </li>
